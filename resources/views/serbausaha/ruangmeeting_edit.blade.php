...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <br><br>
            @else 
            <a href="{{ url('serbausaha/ruangmeeting/approval/'.$data->header->id_order.'/1')}}" class="btn btn-primary btn-sm">Approve</a>
            <a href="{{ url('serbausaha/ruangmeeting/approval/'.$data->header->id_order.'/0')}}" class="btn btn-danger btn-sm">Reject</a>
            @endif
