...
{ 
    public $title = 'Tiketing Kereta';
    public $layanan = 'kereta';
	...
	{
		$r = (object) RestCurl::exec('GET',env('LINK_API').'data/orderlist?start=0&length=1000&id_kategori=3');
        $list =  @$r->data->data;
	...
	{ 
        ...
        $res = (object) RestCurl::exec('GET',env('LINK_API').'/backend/toko/detailData?id_layanan=1&id_kategori=3&id_order='.$id);
