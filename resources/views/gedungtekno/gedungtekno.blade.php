           ...
           <table id="dataTable" class="table table-bordered">
               ...
               <tbody>
                   ...
                   <tr>
                       ...
                       <td>{{ $lists->pilihan_paket }}</td> 
                       <td>{{ date('d F Y H:i:s',strtotime($lists->tanggal_book)) }}</td> 
                       <td>{{ $lists->no_hp }} </td>
                       <td>
                       ...
                       <td><a href="{{ url('gedungtekno/detail/'.$lists->id_order.'/'.$lists->id_kategori.'/' .$lists->nama_kategori) }}" class="btn btn-primary btn-sm">Detail</a></td>
                   </tr>
