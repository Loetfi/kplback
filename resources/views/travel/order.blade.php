...
<div class="container-fluid">
	...
	<div class="col-sm-3">
		<div class="card shadow mb-4">
			<div class="card-header">
				<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-hotel"></i> <a href="{{ url('travel/pesawat') }}">Hotel</a></h6>
			</div> 
		</div>
	</div>
	<div class="col-sm-3">
		<div class="card shadow mb-4">
			<div class="card-header">
				<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-car"></i> <a href="{{ url('travel/pesawat') }}">Bus</a></h6>
			</div> 
		</div>
	</div>
	<div class="col-sm-3">
