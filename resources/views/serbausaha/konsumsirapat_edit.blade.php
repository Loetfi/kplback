...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <br><br>
            @else 
            <a href="{{ url('serbausaha/konsumsirapat/approval/'.$data->header->id_order.'/1')}}" class="btn btn-primary btn-sm">Approve</a>
            <a href="{{ url('serbausaha/konsumsirapat/approval/'.$data->header->id_order.'/0')}}" class="btn btn-danger btn-sm">Reject</a>
            @endif
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ date('d F Y H:i:s',strtotime($d->tanggal_book)) }} </td>
                    </tr>
